...
void astPrint(AST *node, int level)
{
    ...
    // Function Call
    case AST_FUNCTION_START:    fprintf(stderr, "AST_FUNCTION_START");  break;
    case AST_LEXP_FIRST:    fprintf(stderr, "AST_LEXP_FIRST");  break;
    case AST_LEXP_NEXT:     fprintf(stderr, "AST_LEXP_NEXT");   break;
    case AST_READ:          fprintf(stderr, "AST_READ");        break;

    // Function Decl
    case AST_FUNC_I:        fprintf(stderr, "AST_FUNC_I");        break;
    case AST_FUNC_C:        fprintf(stderr, "AST_FUNC_C");        break;
    case AST_FUNC_F:        fprintf(stderr, "AST_FUNC_F");        break;
    case AST_PARA_START:    fprintf(stderr, "AST_PARA_START");  break;
    case AST_PARA_NEXT:     fprintf(stderr, "AST_PARA_NEXT");   break;
    case AST_PARA_I:        fprintf(stderr, "AST_PARA_I");        break;
    case AST_PARA_C:        fprintf(stderr, "AST_PARA_C");        break;
    case AST_PARA_F:        fprintf(stderr, "AST_PARA_F");        break;

    // Var Declaration
    case AST_LDEC:          fprintf(stderr, "AST_LDEC");        break;
    case AST_VAR_I:         fprintf(stderr, "AST_VAR_I");        break;
    case AST_VAR_C:         fprintf(stderr, "AST_VAR_C");        break;
    case AST_VAR_F:         fprintf(stderr, "AST_VAR_F");        break;

    // Vector Decl
    case AST_VECT_I:        fprintf(stderr, "AST_VECT_I");        break;
    case AST_VECT_C:        fprintf(stderr, "AST_VECT_C");        break;
    case AST_VECT_F:        fprintf(stderr, "AST_VECT_F");        break;
